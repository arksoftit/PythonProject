...
def calcular_fecha_vencimiento(fecha_creacion, fecha_renovada=None):
    """
    Calcula la fecha de vencimiento para el año en curso basándose en la fecha de creación.
    Args:
    ...
    # Crear la fecha de vencimiento para el año en curso
    fecha_vencimiento = datetime(hoy.year, fecha_creacion_dt.month, fecha_creacion_dt.day)

    # Ajustar el año si la fecha de vencimiento ya pasó este año
